...
import { checkVendor, getVendorByContractAddress } from 'services/vendorfactory.service';
            ...
            <div className={styles.theStoresPageContainer}>
                <div className={styles.storeHeaderContainer}>
                    ...
                    <div className={styles.storeDetailsContainer}>
                        <Avatar size={120} src={vendorData?.logo} className={styles.storeLogo} />
                        <Row align="middle" justify="space-between" className={styles.storeDetails}>
                            <div className={styles.storeName}>{vendorData?.name} <VscVerifiedFilled className={styles.verifyIcon} /></div>
                        ...
                        <Row align="middle" className={styles.storeSpecs}>
                            <div className={styles.storeSpec}>Store items <span>{specStoreProducts?.length}</span></div>
                ...
                <div className={styles.pageContent}>
                    ...
                    <Row align="middle" justify="space-between" className={styles.searchRow}>
                        <Row align="middle" style={{ gap: 10 }} >
                            <SearchBar className={styles.bar} /><div className={styles.results}>{specStoreProducts?.length} results</div>
                        </Row>
                        <Col>
                    ...
                    <div className={styles.itemsList}>
                        {specStoreProducts?.map((item, idx) => {
                            return (
                                <StoreItemCard key={idx} item={item} setBuyProductModal={setBuyProductModal} />
                            )
                        })}
                ...
                <PlaceOrderModal visible={buyProductModal} setVisible={setBuyProductModal} storeAddress={storeAddress} />
