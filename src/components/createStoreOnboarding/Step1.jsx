...
const OnboardingStep1 = ({setCurrentStep}) => {
    ...
    return (
        <div className={styles.onboardingStepContainer}>
            ...
            <Form className={`${formStyles.formContainer} ${styles.onboardingForm}`} layout='vertical' onFinish={createVendor}>
                <Form.Item
                    name="name"
                    label="Store Name"
                ...
                >
                    <Input className={formStyles.formInput} placeholder='Enter your logo url' />
                </Form.Item>
                <PrimaryButton
